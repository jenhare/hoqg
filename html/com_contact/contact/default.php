...
<!-- Show name in title and info following -->
...
<!-- I want to comment the contact components contact information out so it doesn't display
	...
	<?php endif; ?>
End comment out contact component contact information-->
	<?php if ($this->params->get('presentation_style') == 'sliders') : ?>
		<?php echo JHtml::_('bootstrap.endSlide'); ?>
	<?php endif; ?>
	<?php if ($this->params->get('presentation_style') == 'tabs') : ?>
